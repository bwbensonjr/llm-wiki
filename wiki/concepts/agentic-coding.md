...
- Agents "thrive on feedback," both in RL training and in use; [[formal-methods|
  formal methods]] and [[type-systems|type systems]] are powerful feedback
  signals that improve their results.
